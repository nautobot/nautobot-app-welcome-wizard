...
class ManufacturerImport(PrimaryModel):  # pylint: disable=too-many-ancestors
    """Base model for Welcome Wizard app."""
    ...
    class Meta:
        ...
        # verbose_name_plural = "Welcome Wizards"
