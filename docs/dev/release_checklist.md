...
```no-highlight
> poetry version
nautobot-welcome-wizard 1.0.0-beta.2
```
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/nautobot/nautobot-app-welcome-wizard/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/nautobot/nautobot-app-welcome-wizard/compare/v1.4.1...v1.4.2
```
