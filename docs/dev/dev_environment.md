...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 1.5.0)
...
#14 naming to docker.io/nautobot-welcome-wizard/nautobot:1.5.0-py3.11 done
```
...
ee90fbfabd77   nautobot-welcome-wizard/nautobot:1.5.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               welcome_wizard_worker_1
b8adb781d013   nautobot-welcome-wizard/nautobot:1.5.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   welcome_wizard_nautobot_1
d64ebd60675d   nautobot-welcome-wizard/nautobot:1.5.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   welcome_wizard_docs_1
...
So for example, our plugin is named `nautobot-welcome-wizard`, the command would most likely be `docker logs welcome_wizard_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
