...
The Welcome Wizard automatically tracks the resources in Nautobot. For instance, once you add a `Location` to Nautobot,
...
Tracking fields that are ignored is done through the Nautobot Admin Panel. Head over to the user menu (top-right), then into the admin panel, and navigate to `Welcome Wizard` under the `Nautobot Welcome Wizard` heading.
...
![Ignored Dashboard](../images/dashboard_with_ignored_light.png#only-light){ .on-glb }
![Ignored Dashboard](../images/dashboard_with_ignored_dark.png#only-dark){ .on-glb }
...
![Welcome Wizard Banner](../images/merlin_banner_light.png#only-light){ .on-glb }
![Welcome Wizard Banner](../images/merlin_banner_dark.png#only-dark){ .on-glb }
...
![Middleware message x1](../images/merlin_middleware_import_light.png#only-light){ .on-glb }
![Middleware message x1](../images/merlin_middleware_import_dark.png#only-dark){ .on-glb }

If multiple required fields have missing resources you will get a message for each missing item.

![Middleware message x3](../images/merlin_middleware_x3_light.png#only-light){ .on-glb }
![Middleware message x3](../images/merlin_middleware_x3_dark.png#only-dark){ .on-glb }
